...
class Endpoint(models.Model):
    '''
    This Endpoint class represents Machine Learning API endpoint.
...
class MLAlgorithm(models.Model):
    '''
    This MLAlgorithm class represents the Machine Learning algorithm object.
...
class MLAlgorithmStatus(models.Model):
    '''
    The MLAlgorithmStatus class represent status of the MLAlgorithm which can change during the time.

    Attributes:
        status: The status of algorithm in the endpoint. It Can be: testing, staging, production or ab_testing.
...
class MLRequest(models.Model):
    '''
    The MLRequest class will keep information about all the requests to ML algorithms.
